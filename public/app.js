$(document).ready(function() {
  ...
  $(document).on("click", ".a2", function googleLogin() {
    ...
    function parseIngredient(selectedDrink) {
      ...
      for (let i = 0; i < 14; i++) {
        //API returns a fixed 15 ingredients for every drink
        let tempIngredient = selectedDrink.drinks.strIngredient[i];
        ingredientArray.push(tempIngredient);
      }
      ingredientArray = jQuery.grep(arr, function(n) {
        return n;
    ...
    function parseMeasurement(selectedDrink) {
      ...
      measurementArray = jQuery.grep(arr, function(n) {
        return n;
      }); //trims empty fields from array
      return measurementArray;
    }
  
    function drinkDetailDOM(selectedDrink, ingredients, measurements) {
      //ingredients and measurements are arrays
      ...
      for (let i = 0; i < ingredients.length; i++) {
        // loop through corrected length ingredient array
